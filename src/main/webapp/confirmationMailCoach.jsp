<%-- 
    Document   : confirmationMailCoach.jsp
...
<f:view>
    <html>
        <head>
            ...
            <![endif]-->
            <title>Confirmation Changement Mail Coaching</title>
        </head>
        <body>
			...
			<div class="fh5co-contact">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
                                        <div class="fh5co-intro fh5co-table-cell animate-box">
                                            <h1>Le changement de d'adresse mail de coaching a été pris en compte.</h1>
